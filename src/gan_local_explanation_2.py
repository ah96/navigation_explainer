...
def local_plan_callback(msg):
    ...
    print('local plan lenght = ', len(msg.poses))
    ...
    transf = tfBuffer.lookup_transform('odom', 'odom', rospy.Time())
...
def global_plan_callback(msg):
    ...
    print('global plan = ', len(msg.poses))     
...
sub_local_plan = rospy.Subscriber("/move_base/PalLocalPlanner/global_plan", Path, local_plan_callback)
